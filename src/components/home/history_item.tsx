...
export function HistoryItem({
	...
	return (
		<div className="md:hover:backdrop-brightness-200 py-4 px-6 rounded-box transition-all md:cursor-pointer">
			<div className="text-sm font-semibold uppercase tracking-wide text-base-content/70">
				{period}
			</div>
			<h3 className="text-xl font-semibold mt-2">{title}</h3>
			<p className="font-medium text-base-content/70 text-primary">
				{position}
			</p>
